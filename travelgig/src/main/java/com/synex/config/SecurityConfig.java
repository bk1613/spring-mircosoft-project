...
//		return new BCryptPasswordEncoder();
	...
	protected void configure(HttpSecurity http) throws Exception{
		http.authorizeRequests().antMatchers("/saveQA", "/getuserQAs", "/getQAs", "/signupform",  "/", "/gethotel", "/getroom", "/savebooking", "/saveuser", "/getHotelreview").permitAll()//all request is authorized to be accessed, get user, save user, create role wihtout logging in
